  ...
  _ref = _asyncToGenerator(function* (opts) {
    ...
    function createStream(src) {
      return _vinylFs.default.src(src, {
        allowEmpty: true,
        base: srcPath
      }).pipe(_through.default.obj((file, env, cb) => {
        if (/\.(j|t)sx?/.test((0, _path.extname)(file.path))) {
    ...
    return new Promise(resolve => {
      createStream([(0, _path.join)(srcPath, '**/*'), `!${(0, _path.join)(srcPath, '**/fixtures/**/*')}`, `!${(0, _path.join)(srcPath, '**/.(test|e2e|spec).(js|jsx|ts|tsx)')}`]).on('end', () => {
        if (watch) {
